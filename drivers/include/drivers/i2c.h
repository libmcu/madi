...
{
	return ((struct i2c_interface *)self)->init(self);
}

static inline int i2c_deinit(struct i2c *self)
{
	return ((struct i2c_interface *)self)->deinit(self);
}

static inline int i2c_write(struct i2c *self, uint8_t addr, uint8_t reg,
			    const void *data, size_t data_len)
{
	return ((struct i2c_interface *)self)->write(self, addr, reg,
					      data, data_len);
}
...
{
	return ((struct i2c_interface *)self)->read(self, addr, reg,
					     buf, bufsize);
}
